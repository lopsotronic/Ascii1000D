...
:toclevels: 4
:experimental:
:title-page-background-image: image:../GFX/_TeledyneFLIR.png[scaledwidth=100%]
:numbering:
:sectnums:
:sectnumlevels: 5
...
//:docinfo: shared
:title-logo-image: ../GFX/_TeledyneFLIR.png[scaledwidth=100%]
...
The following examples use image callouts to describe what data is populating that specific page element:

<<cover_recto,Legend for Cover Page Template>>

<<content_verso,Legend for Content, Verso>>

.[[cover_recto]]Cover Page Template (title recto)
image::../GFX/DMC-DEMO-000-10-00-01A-000A-A.png[scaledwidth=100%]
...
.Book title verso
image::../GFX/DMC-DEMO-000-10-00-01A-002A-A.png[scaledwidth=100%]

.Front Matter: ToC (autogen)
image::../GFX/DMC-DEMO-000-10-00-01A-003A-A.png[scaledwidth=100%]

.Front Matter: LoF (autogen)
image::../GFX/DMC-DEMO-000-10-00-01A-004A-A.png[scaledwidth=100%]

.Front Matter: LoT (autogen)
image::../GFX/DMC-DEMO-000-10-00-01A-006A-A.png[scaledwidth=100%]

.Intentionally Blank Page (autogen)
image::../GFX/DMC-DEMO-000-10-00-01A-005A-A.png[scaledwidth=100%]

.Chapter title page (always recto side)
image::../GFX/DMC-DEMO-000-10-00-01A-007A-A.png[scaledwidth=100%]

.[[content_verso]]Content page, left side (verso)
image::../GFX/DMC-DEMO-000-10-00-01A-008A-A.png[scaledwidth=100%]
...
image::../GFX/DMC-DEMO-000-10-00-01A-009A-A.png[scaledwidth=100%]

.Index (autogen)
image::../GFX/DMC-DEMO-000-10-00-01A-010A-A.png[scaledwidth=100%]

.Glossary (gentext label "Terminology")
image::../GFX/DMC-DEMO-000-10-00-01A-011A-A.png[scaledwidth=100%]
