...
link:#ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_par-0001[Cantilever brake]).

[[ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_par-0001]]
=== Cantilever brake

The brake system (refer to
link:#ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_fig-0001[Cantilever brake with
straddle cable]) has these primary components:

* the brake lever (refer to
link:#ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_par-0003[Brake lever])
* the brake cable
* the brake arm
* the brake clamp (also known as callipers)
* the brake pads (refer to
link:#ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_par-0002[Brake pads])
...
[[ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_par-0002]]
=== Brake pads

There are four brake pads (refer to
link:#ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_fig-0002[Exploded diagram of a
brake]) on the bicycle. Two are found on the front wheel and two on the
rear wheel. The brake pads are made out of hard wearing rubber. The pads
press against the rim of the wheel to cause friction when the you
...
[[ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_par-0003]]
=== Brake lever

The brake levers (refer to
link:#ID_BRAKE-AAA-DA1-00-00-00AA-041A-A_fig-0003[Typical components of
a mountain bicycle lever]) are easily damaged. The lever is installed in
the mount. A clamp bolt holds the mount. This bolt is not visible
because it is found in the mount. The lever turns on a lever pivot bolt.
The adjuster lock nut holds the brake cable. This lock nut adjusts the
