...
<xsl:strip-space elements="table row entry tr td tgroup thead"/>

<!-- <xsl:template match="article/bookinfo">
...
<!-- Universal MX/OPS step processor -->
...
<xsl:template match="task/procedure/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="task/procedure/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="task/procedure/step/substeps/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="task/procedure/step/substeps/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="task/procedure/step/substeps/step/substeps/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="task/procedure/step/substeps/step/substeps/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
.... {blank}<xsl:apply-templates/>
 ...
 -->
<!-- Transform steps OPS-->
<!-- <xsl:template match="sect1/procedure">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/procedure">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/procedure/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/procedure/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/step/substeps/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/procedure/step/substeps/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/step/substeps/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/procedure/step/substeps/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/step/substeps/step/substeps/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/procedure/step/substeps/step/substeps/step/substeps">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/step/substeps/step/substeps/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:template match="sect1/procedure/procedure/step/substeps/step/substeps/step">
<xsl:call-template name="process-id"/>
<xsl:if test="@spacing">
[options="<xsl:value-of select="@spacing"/>"]
</xsl:if>
...
<xsl:if test="ancestor::listitem|step and preceding-sibling::element()">
  <xsl:choose>
...
<xsl:choose>
  ...
  <xsl:when test="ancestor::listitem|step and following-sibling::element()">
    <xsl:value-of select="util:carriage-returns(1)"/>
  </xsl:when>
  <xsl:otherwise><xsl:value-of select="util:carriage-returns(2)"/></xsl:otherwise>
</xsl:choose>
...
<xsl:apply-templates select="node()"/>
<xsl:choose>
<xsl:when test="following-sibling::para|following-sibling::simpara|para">
...
<xsl:template match="td/para|td/simpara">
<xsl:call-template name="process-id"/>
<xsl:apply-templates select="node()"/>
<xsl:choose>
<xsl:when test="following-sibling::para|following-sibling::simpara|para">
...
<xsl:when test="parent::td[not(following-sibling::entry)]">
  <!-- One carriage return if last para in last entry in row -->
  <xsl:value-of select="util:carriage-returns(1)"/>
</xsl:when>
</xsl:choose>
...
<xsl:template match="tip|warning|note|caution|important">
            <xsl:if test="parent::listitem|step"> <xsl:value-of select="util:carriage-returns(1)"/><xsl:text>+</xsl:text>
            </xsl:if>
<xsl:call-template name="process-id"/>
...
<xsl:for-each select="listitem"> <xsl:for-each select="ancestor::itemizedlist"><xsl:text>*</xsl:text></xsl:for-each>
    <xsl:text> {blank}</xsl:text><xsl:apply-templates/>
</xsl:for-each>
...
<xsl:for-each select="title"> <xsl:for-each select="ancestor-or-self::orderedlist"><xsl:text>=</xsl:text></xsl:for-each>
    <xsl:text> </xsl:text><xsl:apply-templates/><xsl:value-of select="util:carriage-returns(2)"/>
</xsl:for-each>
<xsl:for-each select="listitem"> <xsl:for-each select="ancestor-or-self::orderedlist"><xsl:text>.</xsl:text></xsl:for-each>
    <xsl:text> {blank}</xsl:text><xsl:apply-templates/>
</xsl:for-each>
<xsl:apply-templates select="*[not(self::listitem)]"/>
</xsl:template>
...
<!-- Nested orderedlist items --> 
<!-- <xsl:template match="listitem">
  <xsl:for-each select="ancestor::orderedlist"><xsl:text>.</xsl:text></xsl:for-each>
...
<xsl:if test="@language != ''">
          ...
          process child <co> elements. -->
                ...
                <xsl:text>....</xsl:text>
                <xsl:choose>
                  <xsl:when test="ancestor::listitem|step and preceding-sibling::element()"><xsl:value-of select="util:carriage-returns(1)"/></xsl:when>
                  <xsl:otherwise><xsl:value-of select="util:carriage-returns(2)"/></xsl:otherwise>
                </xsl:choose>
              </xsl:when>
      ...
      <xsl:when test="co">
        <xsl:choose>
          ...
          <xsl:when test="*[not(self::co) and not(indexterm)]">
            <xsl:if test="ancestor::listitem|step and preceding-sibling::element()"><xsl:text>+</xsl:text>
              <xsl:value-of select="util:carriage-returns(1)"/>
            </xsl:if>
++++++++++++++++++++++++++++++++++++++
<xsl:copy-of select="."/>
...
++++++++++++++++++++++++++++++++++++++
          ...
          <xsl:otherwise>
            <xsl:value-of select="util:carriage-returns(1)"/>
            <xsl:if test="ancestor::listitem|step and preceding-sibling::element()"><xsl:text>+</xsl:text><xsl:value-of select="util:carriage-returns(1)"/></xsl:if>
            <!-- Preserve non-empty "language" attribute if present -->
            <xsl:if test="@language != ''">
              <xsl:text>[source, </xsl:text>
              <xsl:value-of select="@language"/>
...
<xsl:if test="col/@class='challeng'">
<xsl:value-of select="util:carriage-returns(1)"/>
<xsl:text>+</xsl:text><xsl:value-of select="util:carriage-returns(1)"/>
<xsl:text disable-output-escaping="yes">[width="100%",cols="&lt;8,&gt;8", frame="topbot", grid="rows", stripes="all"]</xsl:text>
</xsl:if>
|===
...
<xsl:template match="row|tr">
  <xsl:for-each select="entry|td">
    <xsl:text>|</xsl:text>
    <xsl:apply-templates/>
  </xsl:for-each>
      <xsl:if test="not (entry/para)">
    </xsl:if>
    <xsl:if test="not (td/para)">
    </xsl:if>
</xsl:template>
